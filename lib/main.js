...
const mongoDeleteBeforeToday = require('../utils/mongoDeleteBeforeToday.js');
      ...
      getKey('mlab')
        .then(uri => {
          mongodb.MongoClient.connect(uri, (err, db) => {
            ...
            // mongoDeleteBeforeToday(dbName, market);
            ...
            // db.collection(dbName).count().then(x => {
            //   log[market].totalEvents = x;
            // });

            // const getTotalEvents = () => {
            //   allEvents.count().then((x) => {
            //     return x;
            //   });
            // };
